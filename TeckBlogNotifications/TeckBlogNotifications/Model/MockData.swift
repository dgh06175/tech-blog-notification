...
struct SamplePosts {
    static var contents: [Post] = [
        Post(blogName: "Toss Tech", link: "https://toss.tech/article/react-native-2024", title: "토스가 꿈꾸는 React Native 기술의 미래", timestamp: "2024. 3. 25".parseDate(), isBookMark: false, bookMarkCount: 0, isSeen: false, tags: ["React Native", "Mobile"]),
        ...
        Post(blogName: "Kakao Tech", link: "https://tech.kakao.com/2024/04/29/techmeet-web-editor/", title: "웹 텍스트 에디터 개발에 필요한 고민과 신규 에디터 소개 / 제5회 Kakao Tech Meet", timestamp: "2024. 4. 29".parseDate(), isBookMark: false, bookMarkCount: 0, isSeen: false, tags: ["Web", "Editor"]),
