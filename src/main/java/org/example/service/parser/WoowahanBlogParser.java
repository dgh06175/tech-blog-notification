...
public class WoowahanBlogParser extends AbstractJsoupBlogParser {
    @Override
    ...
    protected Map<String, String> parseElement(Element element) {
        ...
        article.put("date", formattedWoowahanDate(pubDate)); // 'pubDate' 태그
    ...
    private String formattedWoowahanDate(String inputDate) {
